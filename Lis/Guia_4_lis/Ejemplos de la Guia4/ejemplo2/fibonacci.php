...
<span class="navbar-text mx-auto"><h1>Serie de Fibonacci con recursividad</h1></span>
</nav>
</header>
<div class="container">
<?php
...
Fibonacci</th></tr>";
 ...
 echo "<span class='d-block h3 font-weight-normal'>Ingresar nuevosdatos</span>";else:?>
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="GET" >
<div class="form-group row">
 <label class="form-check-label" for="numero1">Valores para serie:</label>
