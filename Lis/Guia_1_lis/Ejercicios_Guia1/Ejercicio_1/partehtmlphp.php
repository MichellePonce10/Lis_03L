...
<!-- Sección HTML alineada a la izquierda -->
  ...
  <div class="card">
    <div class="card-body">
        ...
        <p>Este es un fragmento de codigo HTML basico que esctuctura la pagina.</p>
...
<!-- Sección PHP alineada a la derecha -->
 ...
 <p>Este es un ejemplo de como PHP se integra en una pagina wed para generar contenido dinamico.</p>
 </div>
 <div class="card-footer text-center">
