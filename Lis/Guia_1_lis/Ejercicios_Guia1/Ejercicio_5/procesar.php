...
if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])):
    ...
    extract($_POST);
    $cliente = !empty($client) ? $client : "<a href='ingresodatos.html' class='text-danger'>No ingresó el cliente.</a>";
    echo "\t\t<td>" . $cliente . "</td>\n";
    echo "\t</tr>\n";
    echo "\t<tr>\n";
    echo "\t\t<td>Producto</td>\n";
    $producto = !empty($product) ? $product : "<a href='ingresodatos.html' class='text-danger'>No ingresó el producto.</a>";
    echo "\t\t<td>" . $producto . "</td>\n";
    echo "\t</tr>\n";
    echo "\t<tr>\n";
    echo "\t\t<td>Precio</td>\n";
